// this is register page. same as draw.js but require certain value to proceed
var drawModule = (function() {
  ...
  var apple = function(x, y) {
   ...
   var scoreTextDummy = function() {
     ...
     ctx.fillStyle = "red";
     ctx.fillText(scoreDummy_text, 155, h-5);
  ...
  var paint = function() {
    ...
    if (eat < 3) {
      ...
      registerbutton.removeAttribute("disabled", true); //Reset the game
      ctx.clearRect(0, 0, w, h);
      gameloop = clearInterval(gameloop);
